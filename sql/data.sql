...
INSERT INTO videos(videoid, username, projectid, filename, starttime, endtime, created)
VALUES (1, 'azarrabi', 1, 'test.mov', 1554572537, 1554572540, datetime('now', 'localtime')),
	   (2, 'armruval', 2, 'test.mov', 1554572537, 1554572540, datetime('now', 'localtime')),
	   (3, 'btajfel', 3, 'test.mov', 1554572537, 1554572540, datetime('now', 'localtime'));
